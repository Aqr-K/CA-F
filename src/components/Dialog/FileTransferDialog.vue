<template>
    <VDialog scrollable max-width="50rem" :fullscreen="!display.mdAndUp.value" class="file-transfer">
        <VCard :title="dialogTitle" class="rounded-t">
            ...
            <v-card-text>
                <v-form>
                    <v-row>
                        <v-col cols="12" md="8">
                            <VCombobox v-model="transferForm.target" :items="targetDirectories" label="目的路径"
